...
const App = () => {
  ...
  return (
    <div>
      ...
      <Switch>
        <Route path='/anecdotes/:id'><Anecdote anecdotes={anecdotes} anecdoteById={anecdoteById} /></Route>
        <Route path='/about'><About /></Route>
        <Route path='/create'><CreateNew addNew={addNew} setNotification={setNotification} /></Route>
